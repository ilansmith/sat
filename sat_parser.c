...
static void st_error(void *o)
{
	...
	break;
    case ERR_RPAREN:
	err_msg = "')' is either end of predicate or is followed by an \"and\" "
	    "surrounded by white spaces and followed by another clause";
	break;
    ...
    {
	char *ch_prefix = cs_getpos(cs) - 1 == p->error_pos ? C_HIGHLIGHT : 
	    C_NORMAL;
